...
export function residenceSchema() {
  return {
    ...
    name: PROJECT_NAME,
    description:
      "Arbourview is a pre-construction community by Mattamy Homes in Georgetown, Halton Hills, Ontario, offering townhomes and detached WideLot™ homes.",
    url: `${SITE_URL}/`,
 ...
 *   "url": "https://arbourviewhomes.com/pricing"
 * }
 */
