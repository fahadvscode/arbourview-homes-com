...
const gsc = process.env.NEXT_PUBLIC_GSC_VERIFICATION; // replace NEXT_PUBLIC_GSC_VERIFICATION with a real token before launch
const bing = process.env.NEXT_PUBLIC_BING_VERIFICATION; // replace NEXT_PUBLIC_BING_VERIFICATION with a real token before launch
