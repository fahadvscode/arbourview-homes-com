    ...
    <>
      ...
      <Section labelledBy="next">
        ...
        <p className="mt-4 max-w-[62ch] text-text-primary">
          ...
          read a Halton Hills pre-construction file before a price list exists, and what remains
          unpublished for Arbourview.
        </p>
        <div className="mt-8 flex flex-wrap gap-3">
          <CtaLink href="/blog/oakville-pre-construction-guide" location="thank_you">
            Read the Halton Hills pre-construction guide
          </CtaLink>
