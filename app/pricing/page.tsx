  ...
  return (
    <>
      ...
      <Section labelledBy="status">
        <SectionHeading id="status">Arbourview prices — current status</SectionHeading>
      ...
      <Section alt labelledBy="deposit">
        <SectionHeading id="deposit">Arbourview deposit structure</SectionHeading>
      ...
      <Section alt labelledBy="status-notes">
        ...
        <div className="mt-8">
          <Prose>
            ...
            <p>
              Occupancy for Arbourview is to be announced.{" "}
