  ...
  return (
    <>
      ...
      <Section labelledBy="tiers">
        <SectionHeading id="collections">Arbourview floor plans by collection</SectionHeading>
        <p className="mt-4 max-w-[62ch] text-text-muted">
          Townhomes and detached WideLot™ homes are the two planned tiers. Square footage and bedroom
