...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <Hero />
      <AnswerFirstSummary heading="Arbourview Georgetown, in one paragraph">
        <p>{HOME_ANSWER}</p>
      </AnswerFirstSummary>
      ...
      <Section alt labelledBy="overview">
        <SectionHeading id="overview">Arbourview Georgetown — the public fact sheet</SectionHeading>
        <div className="mt-8">
          <Prose>
      ...
      <Section alt labelledBy="collections" id="floor-plans-preview">
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2">
          {FLOOR_PLAN_COLLECTIONS.map((collection) => (
            <FloorPlanCard key={collection.name} collection={collection} />
          ))}
        </div>
      </Section>
